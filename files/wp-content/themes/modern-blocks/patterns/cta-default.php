 ...
 * Slug: modern-blocks/cta-default
...
<h2 class="wp-block-heading has-text-align-center has-x-large-font-size"><?php esc_html_e( 'Add Call to Action Heading Here', 'modern-blocks' ); ?></h2>
<!-- /wp:heading -->
...
<p class="has-text-align-center" style="margin-top:var(--wp--preset--spacing--small)"><?php esc_html_e( 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 'modern-blocks' ); ?></p>
<!-- /wp:paragraph -->
