 ...
 * Slug: modern-blocks/latest-articles
...
<p class="has-primary-color has-text-color has-base-font-size"><?php esc_html_e( 'Stay Tuned With', 'modern-blocks' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:heading {"style":{"spacing":{"margin":{"top":"0.25rem"}}},"fontSize":"x-large"} -->
<h2 class="wp-block-heading has-x-large-font-size" style="margin-top:0.25rem"><?php esc_html_e( 'Our Latest Articles', 'modern-blocks' ); ?></h2>
<!-- /wp:heading --></div>
<!-- /wp:column -->

<!-- wp:column {"verticalAlignment":"bottom"} -->
<div class="wp-block-column is-vertically-aligned-bottom"><!-- wp:paragraph {"style":{"spacing":{"margin":{"bottom":"0.65rem"}}}} -->
<p style="margin-bottom:0.65rem"><?php esc_html_e( 'Check out the latest deals, read detailed articles, and explore case studies for the complete picture, all in a snap.', 'modern-blocks' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
